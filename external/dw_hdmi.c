...
)
{
  ...
  // DEBUG((DEBUG_VERBOSE, "i2c maunit irq:%02x\n", Stat));
	if (I2c->Stat) {
...
//      case 0:
//        GpioPinSetFunction(4, RK_PIN_B7, 0x5);
//        GpioPinSetFunction(4, RK_PIN_C0, 0x5);
//        break;
//      case 1:
//        GpioPinSetFunction(0, RK_PIN_D5, 0xb);
//        GpioPinSetFunction(0, RK_PIN_D4, 0xb);
//        break;
//      case 2:
//        GpioPinSetFunction(3, RK_PIN_C7, 0x5); // gpio3c7_sel HDMI_TX0_SCL_M2
//        GpioPinSetFunction(3, RK_PIN_D0, 0x5); // gpio3d0_sel HDMI_TX0_SDA_M2
//        break;
//      default:
//        break;
//    }
...
//    switch (Hdmi->I2c.PinMux) {
//      case 0:
//        GpioPinSetFunction(2, RK_PIN_B4, 0x4);
//        GpioPinSetFunction(2, RK_PIN_B5, 0x4);
//        break;
//      case 1:
//        GpioPinSetFunction(3, RK_PIN_C5, 0x5);
//        GpioPinSetFunction(3, RK_PIN_C6, 0x5);
//        break;
//      case 2:
//        GpioPinSetFunction(1, RK_PIN_A3, 0x5);
//        GpioPinSetFunction(1, RK_PIN_A4, 0x5);
//        break;
//      default:
//        break;
//    }
...
//  DwHdmiQpRegMod(Hdmi, HDCP2_BYPASS, HDCP2_BYPASS, HDCP2LOGIC_CONFIG0); // 96000010
...
// //#include "shared_ctx.h"
//
//int edk_preinit_hdmi(struct Context *ctx) {
//  int rc = DwHdmiQpConnectorPreInit(&ctx->priv, &ctx->out);
//
//  // WTF this doesn't even do anything
//  rc = DwHdmiQpConnectorInit(&ctx->priv, &ctx->out);
//  DRM_DISPLAY_MODE *DrmMode = &ctx->out.ConnectorState.DisplayMode;
...
//                      ctx->out.ConnectorState.BusFormat));
//
//
//  return rc;
//}
//
//int edk_init_hdmi(struct Context *ctx) {
//  struct RockchipHdptxPhyHdmi Hdptx;
//  Hdptx.Id = PcdGet32(PcdHdmiId);
//  HdptxRopllCmnConfig(&Hdptx);
//  return 0;
//}
//
//int edk_bringup_hdmi(struct Context *ctx) {
//  return DwHdmiQpConnectorEnable(&ctx->priv, &ctx->out);
//}
